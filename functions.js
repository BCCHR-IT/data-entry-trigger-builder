...
function addTrigger()
{
    ...
    html = html + "<div class='col-sm-6'>" + 
            ...
            "<p>The <b>[redcap_data_access_group]</b> is a special field that can either transfer data access groups 1:1 between projects, or map to a regular REDCap variable (radiobutton or drop-down). If you want to manually set the DAG using a variable in the destination project, then you must use the unique group id of the DAG (example below).</p>" +
